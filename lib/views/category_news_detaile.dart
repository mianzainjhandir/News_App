...
class CategoryNewsDetaile extends StatefulWidget {
  final String newImage, newstitle, newsDate, author, description, content, source;
   CategoryNewsDetaile({super.key,
  ...
  @override
  State<CategoryNewsDetaile> createState() => _CategoryNewsDetaileState();
}

class _CategoryNewsDetaileState extends State<CategoryNewsDetaile> {
